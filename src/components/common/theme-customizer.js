...
const ThemeCustomizer = () => {
    ...
    const sidebar_type = 'horizontal_sidebar'
    ...
    }, [body_sidebar_type, color, configDB.settings.sidebar.bodyWrapper, configDB.settings.sidebar.wrapper, configDB.settings.sidebar_setting, config_color, config_layout_version, config_primary, config_secondary, dispatch, layout_type, layout_version, mix_layout, primary_color, secondary_color]);
